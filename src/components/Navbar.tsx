const Navbar = () => {
    return (
        <nav className="w-full flex justify-between items-center py-6 px-10 border-b border-gray-200/50 max-w-7xl mx-auto text-[#333] bg-[#fbf9f4]">
            ...
            <div className="hidden md:flex space-x-8 text-sm uppercase tracking-widest text-gray-600">
                ...
                <a href="/blessings" className="hover:text-[#52594a]">
                    BLESSINGS
                </a>
            </div>
        </nav>
